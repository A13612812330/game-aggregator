...
> | **当前分享链接** | `https://gamehub-agg-v4.app.workbuddy.host/`（v10.23 起；**已弃用**：`36aa37e9…` 停 v10.22〔未登记，发布工具够不着〕/ `gamehub-agg-v3` 停 v10.21 / `-v2` 停 v10.18 / `-join` 停 v10.17） |
> | 质量基线（当前是 **22 套 1439 条**） | `node tools/run-all.js`（一键跑，实测输出） |
>
