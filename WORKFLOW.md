...
```bash
# 第一层：静态（前置闸 2 个 + 35 套 / 2344 条 / 必须 0 失败）
...
| ① 静态 | `tools/run-all.js` | **35 套 / 2344 条** | 秒级、无需人盯 | 每次改完 |
