...
```bash
# 第一层：静态（前置闸 2 个 + 36 套 / 2416 条 / 必须 0 失败）
...
| ① 静态 | `tools/run-all.js` | **36 套 / 2416 条** | 秒级、无需人盯 | 每次改完 |
| ② 行为 | `test-emulator-page.js`（jsdom，含在 36 套内） | 119 条 | 需服务在 8123 | 每次改完 |
