...
> ## ★ 归档说明（2026-09-18 补，v10.20 时）
>
> 本文最后更新于 **v10.10**，此后又走了 **v10.11 → v10.20 共 10 个版本**。
...
> `https://36aa37e911e6447eb86eb187240daff2.app.workbuddy.host` —— **它还能返回 200，
> 但内容停在很旧的版本**（这正是本项目最容易踩的坑：状态码 200 区分不出新旧，
> 所以判定版本一律比 `index.html` 的 md5）。**当前正式链接见上表。**
>
